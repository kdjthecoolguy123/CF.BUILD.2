...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		['...', 0.1], //0%
		['Massive Skill Issue', 0.2], //From 1% to 19%
		['Bruh', 0.4], //From 20% to 39%
		['Huh', 0.5], //From 40% to 49%
		['What', 0.6], //From 50% to 59%
		['Ok?', 0.69], //From 60% to 68%
		['UNFUNNY SHIT DONT YOU DARE', 0.7], //69%
		['Fine', 0.8], //From 70% to 79%
		['Good', 0.9], //From 80% to 89%
		['Epic', 1], //From 90% to 99%
		['Super Mega Skilled!!!', 1] //The value on this one isn't used actually, since Perfect is always "1"
	];
